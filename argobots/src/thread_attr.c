...
/**
 * @ingroup ULT_ATTR
 * @brief   Set the ULT's preemption type in the attribute object.
 *
 * \c ABT_thread_attr_set_preemption_type() sets the ULT's preemption type in
 * the target attribute object.
 * Default value is ABT_PREEMPTION_DISABLED.
 *
 * @param[in] attr  handle to the target attribute object
 * @param[in] type  preemption type
 * @return Error code
 * @retval ABT_SUCCESS on success
 */
int ABT_thread_attr_set_preemption_type(ABT_thread_attr attr,
                                        ABT_preemption_type type)
{
    ABTI_ENTER;
    int abt_errno = ABT_SUCCESS;
    ABTI_thread_attr *p_attr = ABTI_thread_attr_get_ptr(attr);
...
void ABTI_thread_attr_get_str(ABTI_thread_attr *p_attr, char *p_buf)
{
    ...
    char *preemption_type;
    switch (p_attr->preemption_type) {
        case ABT_PREEMPTION_YIELD:    preemption_type = "YIELD"; break;
        case ABT_PREEMPTION_NEW_ES:   preemption_type = "NEW_ES"; break;
        case ABT_PREEMPTION_DISABLED: preemption_type = "DISABLED"; break;
        default:                      preemption_type = "UNKNOWN"; break;
    }
