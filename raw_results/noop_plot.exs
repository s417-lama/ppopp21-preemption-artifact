...
no_preemption_dir = "#{prefix}_no_preemption"

data_dirs = [
    "#{prefix}_preemption_klts",
    "#{prefix}_preemption_klts_futex",
    "#{prefix}_preemption_klts_futex_local",
    "#{prefix}_preemption_yield",
    "#{prefix}_preemption_disabled",
]
